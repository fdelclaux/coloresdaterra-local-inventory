...
public class AddPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Are you sure you want to add an new item, if you simply want to \nincrease the stock of an existing item in the inventory, please \nselect it on the main page, and then click the \"Add\" button.");
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {Close, Continue});
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {Close, Continue});
    ...
    private void ContinueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ContinueActionPerformed
        if(DoNotShow.isSelected()){
            ColoresDaTerra.doNotShow = true; 
        }
        else{ 
            ColoresDaTerra.doNotShow=false;
        }
